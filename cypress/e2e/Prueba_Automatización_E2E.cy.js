...
describe('Prueba de Registro', () => {
  ...
  it('Registrar y verificar carga de página', () => {
    ...
    Register.Email('juan101@gmail.com');
   ...
   // Validation login
    ...
    Log_in.Email('juan101@gmail.com')
    Log_in.Password('12345') 
    Log_in.Submit()   

    // Reset password
    Resets.Page_Reset_password()
    Resets.Password('123456')
    Resets.Password_Resets('123456')
    Resets.Continue()
